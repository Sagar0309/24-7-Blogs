<table class="table table-bordered">
                    ...
                    @else
                    <a href="{{ route('backend.users.confirm', $user->id) }}" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                    @endif
                    <!-- <a href="{{ route('blog.destroy', $user->id) }}" class="btn btn-xs btn-danger"></a> -->
